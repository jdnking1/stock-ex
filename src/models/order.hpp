...
namespace kse::models {
    struct order {
        ...
        order(order_id_t market_order_id, client_id_t client_id,
            order_id_t client_order_id, side_t side,
            price_t price, quantity_t qty,
            priority_t priority, order* prev_order, order* next_order) noexcept
