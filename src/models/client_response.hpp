...
#pragma pack(push, 1)
	...
	inline std::string client_response_type_to_string(client_response_type type) {
		...
		case client_response_type::INVALID_REQUEST:
	...
	struct client_response_internal {
	...
	struct client_response_external {
		uint64_t sequence_number_ = 0;
		client_response_internal response_;
...
#pragma pack(pop)
	...
	using client_response_queue = kse::utils::lock_free_queue<client_response_internal>;
}
