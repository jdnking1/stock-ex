...
kse::example::trading::liquidity_taker::liquidity_taker(utils::logger* logger, trade_engine* engine, const feature_engine* f_engine, order_manager* om, const trade_engine_config_map& cfgs) :
